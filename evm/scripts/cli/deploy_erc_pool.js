...
async function promptTokenAddress() {
    return new Promise(r => {
        readline.question("Token's contract address [default: 0x8f1c3e24A3F67745570ceaECdF8dEbDAB4951b8D]: ", input => {
            if (input == "")
                return r("0x8f1c3e24A3F67745570ceaECdF8dEbDAB4951b8D")
...
async function promptPoolSigner() {
    return new Promise(r => {
        readline.question("Pool signer [default: 0xcb2276e4760757976438922aaeb0e03114d5b45f]: ", input => {
            if (input == "")
                return r("0xcb2276e4760757976438922aaeb0e03114d5b45f")
