...
module.exports = async function(deployer, network, accounts) {
    ...
    await deployProxy(LiquidityPool, [reserveAddress, safetyModuleAddress, safetyModuleFeeRate, archethicPoolSigner, poolCap, lockTimePeriod, tokenAddress], { deployer });
}
